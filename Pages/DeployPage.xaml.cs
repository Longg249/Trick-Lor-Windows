...
namespace WinDeployPro.Pages
{
    public partial class DeployPage : Page
    {
        ...
        {
            yield return Chk7Zip;
            yield return ChkNotepad;
            yield return ChkPowerToys;
            yield return ChkKeePass;
            yield return ChkTreeSize;
            yield return ChkCCleaner;
            yield return ChkNaps2;
            yield return ChkFoxitReader;
            yield return ChkChrome;
            yield return ChkFirefox;
            yield return ChkBrave;
            yield return ChkVSCode;
            yield return ChkGit;
            yield return ChkPython;
            yield return ChkAnyDesk;
            yield return ChkTeamViewer;
            yield return ChkPuTTY;
            yield return ChkWPS;
            yield return ChkLibreOffice;
            yield return ChkOnlyOffice;
            yield return ChkAdobeReader;
            yield return ChkSumatraPDF;
            yield return ChkPDF24;
            yield return ChkZoom;
            yield return ChkTeams;
            yield return ChkSkype;
            yield return ChkSlack;
            yield return ChkTelegram;
            yield return ChkThunderbird;
            yield return ChkGoogleDrive;
            yield return ChkDropbox;
            yield return ChkOneDrive;
            yield return ChkVLC;
        ...
        private async void InstallSelected_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (ChkVLC.IsChecked == true)          selected.Add(("VLC Media Player",    "VideoLAN.VLC"));
